...
function preprocessor() {
    // variables.dma_a = memory.defaultNamespace.get_uint32_le(0x)
    // variables.dma_b = memory.defaultNamespace.get_uint32_le(0x)
    // variables.dma_c = memory.defaultNamespace.get_uint32_le(0x)
    // variables.callback1 = memory.defaultNamespace.get_uint32_le(0x)
    // variables.callback2 = memory.defaultNamespace.get_uint32_le(0x)
